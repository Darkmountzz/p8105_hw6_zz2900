...
Since the coefficients of variables menarche and momage are not significant at 0.1 significance level, the R-sqaured is not impaired after dropping the two variables(`r summary(bw_model)$r.squared ` vs. `r summary(bw_newmodel)$r.squared `)
